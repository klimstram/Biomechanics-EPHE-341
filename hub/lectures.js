...
window.EPHE341_LECTURES = [
  ...
  { n: '4', title: 'Forces',
    ...
    handout: 'handout.pdf',
    live: ['anatomy of a force vector', 'F = ma', 'tendon tension from a buckle transducer',
           'resolve the quadriceps forces one muscle at a time',
           'weight on four worlds', 'a block on a slope you can tilt',
           'the three anatomical planes, spun', 'a measured step in three dimensions',
           'pressure against sensel count', 'centre of pressure through a step',
           'heel strike against forefoot strike', 'the four running clips',
           'inverse dynamics and EMG at the ankle'] },
  ...
  { n: '5', title: 'Signals',
    ...
    live: ['sample a 10 Hz wave too slowly', 'the four components of a signal',
           ...
           'a signal built back up from its harmonics', 'one graph per component',
